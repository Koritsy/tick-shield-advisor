  ...
  },
{
  ...
  },
  {
    ...
    environmentalEvidence: 'strong',
    healthSafety: 'risk',
    healthRisks: 'Certaines plantes qui repoussent les cerfs ou les tiques sont toxiques et peuvent poser un risque pour les enfants ou les animaux domestiques. Les couvre-sols à l\'épreuve des cerfs peuvent héberger les tiques si ils retiennent l\'humidité du sol (risque démontré pour le pachysandra et le myrte).',
    healthEvidence: 'strong',
  ...
  },
  {
    ...
    effectiveness: 'high',
    effectivenessDetails: 'Presque 100 % d\'efficacité pour réduire les tiques dans l\'environnement. Aucun impact prouvé sur les cas de maladie de Lyme chez l\'humain.',
    evidenceQuality: 'strong',
    effectivenessEvidence: 'strong',
