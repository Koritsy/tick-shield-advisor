...
export const interventions: Intervention[] = [
  ...
  },
  {
    ...
    annualInvestment: '0 $',
    effectiveness: 'low',
    effectivenessDetails: 'Faible efficacité selon les études. L\'efficacité est probablement plus grande si l\'inspection est minutieuse et si la personne a une bonne vision et sait reconnaître une tique.',
    evidenceQuality: 'weak',
    effectivenessEvidence: 'weak',
    environmentalImpact: 'safe',
    environmentalDetails: 'Aucun impact environnemental.',
  ...
  },
  {
    ...
    cost: 'medium',
    costDetails: 'À partir de 45 $ pour le haut et de 100 $ pour le bas, 15 $+ pour le chapeau. Durabilité de 1 an (Richards 2022)',
  ...
  },
  {
    ...
    effectiveness: 'low',
    effectivenessDetails: 'La Nootkatone (qui vient du cèdre jaune de l\'Alaska) et le carvacrol (présent des les huiles de certaines herbes comme l\'origan) seraient les plus efficaces selon les études (Eisen et Dolan 2018). L\'efficacité serait semblable à celle du DEET, mais de plus courte durée (Maia et Moore 2011; Eisen 2024). L\'application doit être répétée régulièrement.',
    evidenceQuality: 'weak',
    effectivenessEvidence: 'weak',
    environmentalImpact: 'safe',
  ...
  },
  {
    ...
    instructions: 'Étendre une couche de copeaux de 1m de largeur et 5cm de profondeur à la bordure du terrain ou du sentier (McKay 2020). Dépendant de la grosseur du terrain, l\'application peut prendre plus d\'une journée.',
    cost: 'medium',
    costDetails: '6 $/sac de 42,5 L ou prix en vrac disponible',
    annualInvestment: '~750 $ pour une bordure de 30 m',
    effectiveness: 'medium',
    effectivenessDetails: '75 % de réduction de la densité de tiques adjacente à la bordure avec une profondeur adéquate. Aucun effet dans certaines études. Certaines études suggèrent que les copeaux de cèdre sont plus efficaces, mais une réduction importante du nombre de tiques a été observée dans des sentiers bordés de copeaux de frêne dans une étude ontarienne.',
    evidenceQuality: 'weak',
    effectivenessEvidence: 'weak',
    environmentalImpact: 'caution',
  ...
  },
  {
    ...
    environmentalEvidence: 'strong',
    healthSafety: 'risk',
    healthRisks: 'Certains produits sont toxiques pour les humains. Les chats sont particulièrement sensibles à la perméthrine. La perméthrine serait peu toxique pour l\'humain (INSPQ)',
    healthEvidence: 'strong',
  ...
  },
  {
    ...
    effectivenessEvidence: 'weak',
    environmentalImpact: 'safe',
    environmentalDetails: 'Faible impact environnemental. Effet ciblé sur des organismes spécifiques (Fischhoff 2017)',
    environmentalEvidence: 'strong',
    healthSafety: 'safe',
  ...
  },
  {
    ...
    instructions: 'Il faut adopter des mesures de protection personnelles pour faire cet entretien dans les zones à risque. Ramasser les feuilles régulièrement (Schulze et al 1995). Tondre le gazon. Ne pas laisser de la nourriture dehors sur le terrain, ne pas entreposer d\'appats de chasse, installer la mangeoire à oiseaux loin de la maison. Effort et temps nécessaire varient selon la grosseur du terrain. Peut s\'avérer laborieux.',
    cost: 'low',
  ...
  },
  {
    ...
    effectiveness: 'unknown',
    effectivenessDetails: 'Effet très peu probable si la connectivité du terrain est maintenue avec une zone boisée. Effet inconnu mais des études démontrent que les tiques évitent l\'eau (Kröber et al 1999). Pourrait limiter le mouvement de certains rongeurs.',
    evidenceQuality: 'weak',
    effectivenessEvidence: 'weak',
    environmentalImpact: 'caution',
  ...
  },
  {
    ...
    instructions: 'Selon le format, étendre ou asperger sur les plantes et surfaces autour du terrain. Répéter l\'application régulièrement (minimum aux 6 à 8 semaines) et après la pluie. Il est recommandé d\'utiliser différents produits en alternance pour éviter que les cerfs s\'accoutument à l\'odeur/goût du répulsif. (Ramakrishan 2022): Effort moyen requis: très facile à appliquer mais peu prendre du temps si on a une grande superficie à couvrir et doit être répété souvent.',
    cost: 'medium',
    costDetails: '15 $+ par litre',
    annualInvestment: '~720 $/an (grande surface)',
    effectiveness: 'medium',
    effectivenessDetails: 'Efficacité variable: repousse en partie les cerfs mais pas complètement. N\'a pas d\'effet sur la densité des tiques à moins de repousser les cerfs de façon constante. Les répulsifs à base d\'odeur de sang, d\'urine, de poils ou de fèces de prédateurs sont les plus efficaces selon la littérature. Perd son efficacité après 6-8 semaines et après la pluie. Moins efficace s\'il n\'y a pas de source alternative de nourriture (Tregoning et Kays 2003; Guerisoli et al. 2020; Ramakrishan 2022) ',
    evidenceQuality: 'weak',
    effectivenessEvidence: 'weak',
    environmentalImpact: 'safe',
  ...
  },
  {
    ...
    categoryScore: 50,
    easeOfUse: 'medium',
    easeOfUseDetails: 'Moyen : le produit doit être mélangé avec une quantité précise d\'appât afin d\'obtenir la bonne dose. On doit utiliser des boîtiers à appâts pour souris verrouillés et à l\'épreuve des autres animaux.',
    instructions: 'Placer les boîtes remplies d\'appâts dans des endroits stratégiques autour du terrain (4,4 stations par 1000 m² selon Pelletier et al 2022). L\'appât doit être remplacé toutes les 2 semaines. Effort moyen : la fabrication de l\'appât requiert un peu de temps, tout comme le remplissage des boîtiers. La dispersion des boîtiers requiert que l\'on se déplace sur le terrain ce qui ne requiert pas un gros effort sauf si le terrain est grand, accidenté, en pente, etc.',
    cost: 'low',
    costDetails: 'Stations vendues en quincaillerie (environ 4,50 $ chacune). L\'appât à base de fipronil en cours de production aux É-U.',
    annualInvestment: '~63 $/an (14 stations pour 10 000 pi²). Les coûts de l\'appât sont à déterminer.',
    effectiveness: 'medium',
    effectivenessDetails: 'Bonne efficacité sur les souris mais l\'effet sur la densité de tiques dans l\'environnement n\'est pas clair (Pelletier 2020, 2022; Poché et al 2020, 2021).',
    evidenceQuality: 'strong',
    effectivenessEvidence: 'strong',
    environmentalImpact: 'caution',
    environmentalDetails: 'Le fipronil a un potentiel de s\'accumuler dans l\'environnement (EPA 2005). Fluralaner voir Diepens 2023.',
    environmentalEvidence: 'strong',
    healthSafety: 'risk',
    healthRisks: 'Fipronil peut causer des effets indésirables (voir NPIC). Fluralaner : aucun effet indésirable rapporté chez l\'humain (Shah et al. 2024; Burgess 2020).',
    healthEvidence: 'strong',
    availability: 'Les stations sont vendues en quincaillerie mais l\'appât est non disponible en vente libre. Un appât à rongeur commercial à base de fipronil serait en cours de production aux É-U (Eisen 2023).',
    applicationFrequency: 'regular',
  ...
  },
  {
    ...
    categoryScore: 50,
    easeOfUse: 'hard',
    easeOfUseDetails: 'Difficile : le terrain doit être plat et le dispositif doit être inaccessible aux enfants tout en restant accessible aux cerfs (Connolly 2022).',
    instructions: 'Doit être installé par un professionnel. 1 dispositif traite les cerfs dans un rayon de 50 acres. Effort : l\'appât doit être remplacé chaque semaine ce qui implique le déplacement avec la charge de nourriture jusqu\'au dispositif, l\'entretien et nettoyage du dispositif, achat d\'appâts etc (Connolly 2022; Schulze 2023; Hornbostel 2024).',
    cost: 'high',
    ...
    effectiveness: 'high',
    effectivenessDetails: 'Plusieurs études démontrent une efficacité (Carroll, Hill et al 2009; Pound et al 2009; Schulze et al 2009; CDC). Résultats peut-être variables si autre source de nourriture disponible (Daniels 2009).',
    evidenceQuality: 'strong',
    effectivenessEvidence: 'strong',
    environmentalImpact: 'caution',
    environmentalDetails: 'Relativement inoffensif pour l\'environnement (ne s\'accumule pas), sauf pour l\'environnement aquatique (toxique pour poissons et invertébrés). Les chats sont particulièrement sensibles à la perméthrine. L\'utilisation des dispositifs peut augmenter la propagation d\'agents pathogènes (Connally 2022).',
    environmentalEvidence: 'strong',
    healthSafety: 'caution',
    healthRisks: 'Faible impact de la perméthrine sur la santé humaine (INSPQ). L\'utilisation des dispositifs peut augmenter la propagation d\'agents pathogènes transmis par contact avec fluides corporels provenant d\'animaux infectés (Connally 2022).',
    healthEvidence: 'strong',
