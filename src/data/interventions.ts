...
export const interventions: Intervention[] = [
  {
    ...
    instructions: 'A. En forêt, marcher sur les sentiers pour limiter le contact avec la végétation sur laquelle les tiques s\'embusquent. Sur le terrain, privilégier les zones ensoleillées, sèches ou peu végétalisées.',
    costDetails: 'Gratuit',
    annualInvestment: '0 $',
    effectivenessDetails: 'L\'efficacité est proportionnelle au degré de pruddence. Le fait de rester surr les sentiers a aussi des effets positifs sur la faune et l\'environnement et peuvent aussi réduire le contact avec d\'autres insectes piqueurs ou avec des plantes nuisibles.',
