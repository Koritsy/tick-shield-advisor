  ...
  },
{
  ...
  },
  {
    ...
    nameFr: 'Pulvérisation d\'agents de contrôle biologiques (nématodes, bactéries, champignons)',
    category: 'landscaping',
    categoryLabel: 'Aménagement paysager',
    categoryScore: 50,
    effectivenessScore: 50,
    ...
    effectiveness: 'medium',
    effectivenessDetails: 'Les champignons (Metarhizium brunneum) sont plus efficaces que les bactéries (Bacillus thuringiensis) et les nématodes. L\'effet persiste moins longtemps que celui de la perméthrine.',
    evidenceQuality: 'weak',
    effectivenessEvidence: 'weak',
    environmentalImpact: 'safe',
