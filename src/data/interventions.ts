...
export const interventions: Intervention[] = [
  {
    ...
    instructions: 'A. En forêt, marcher sur les sentiers en forêt pour limiter le contact avec la végétation sur laquelle les tiques s\'embusquent. Sur le terrain, privilégier les zones ensoleillées, sèches ou peu végétalisées.',
    costDetails: 'Gratuit',
    annualInvestment: '0 $',
