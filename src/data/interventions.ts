...
export const interventions: Intervention[] = [
  ...
  },
  {
    ...
    instructions: 'Placer les boîtes remplies d\'appâts dans des endroits stratégiques autour du terrain (le nombre idéal de stations est de 4 à 5 par 1000 m²)). L\'appât doit être remplacé toutes les 2 semaines. Effort moyen : la fabrication de l\'appât requiert un peu de temps, tout comme le remplissage des boîtiers. La dispersion des boîtiers requiert que l\'on se déplace sur le terrain ce qui ne requiert pas un gros effort sauf si le terrain est grand, accidenté, en pente, etc.',
    cost: 'low',
    ...
    effectiveness: 'medium',
    effectivenessDetails: 'Bonne efficacité sur les souris. Environ 50% de réduction du nombre de tiques dans l\'environnement. Effet faible sur la proportion de tiques infectées. Capacité à réduire le risque de maladies chez l\'humain non déterminée',
    evidenceQuality: 'strong',
    effectivenessEvidence: 'strong',
    environmentalImpact: 'caution',
    environmentalDetails: 'Le fipronil a un potentiel de s\'accumuler dans l\'environnement.  Dans certains pays européens, des études ont démontré que l\'usage du fipronil et du fluralaner comme antiparasitaire chez le chien était lié à des concentrations dans l\'environnement supérieures aux normes.',
    environmentalEvidence: 'strong',
    healthSafety: 'risk',
    healthRisks: 'Fipronil peut causer des effets indésirables sur la santé. Fluralaner : aucun effet indésirable rapporté chez l\'humain.',
    healthEvidence: 'strong',
    availability: 'Les stations sont vendues en quincaillerie mais l\'appât n\' est pas disponible au Canada. Un appât à rongeur commercial à base de fipronil est disponible cans certains états aux É-U.',
    applicationFrequency: 'regular',
